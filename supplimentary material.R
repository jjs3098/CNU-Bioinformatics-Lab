...
ggplot(kd,aes(x=Score))+geom_density(aes(color="Kernal density estimator"),size=1) +
...
colnames(dat) <- rep(c("Chiness","Korean"),c(27,30))
...
Tornadoplot(fdr,main="Toranado plot",label=T,cex = 2, cex.main = 2, col="gray50", lcol = "darkred")
